...
/*     srunner_add_suite(sr, create_g_digicam_error_suite()); */
    ...
    if (environment != ENVIRONMENT_X_ERROR) {
        sr = srunner_create (create_g_digicam_camerabin_suite ());
/*         srunner_add_suite(sr, create_g_digicam_camerabin_xdependant_suite()); */

        if (environment != ENVIRONMENT_MAEMO_ERROR) {
/*             srunner_add_suite(sr, create_g_digicam_camerabin_maemodependant_suite()); */
        }
    }
...
int main (void)
{
    ...
    printf ("\n");
    printf ("******************************************************************\n");
    printf (" Executing gdigicam camerabin unit tests.... \n");
    printf ("******************************************************************\n\n");
